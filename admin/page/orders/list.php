                        ...
                        <?php foreach($list as $item) { ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="/admin/?act=orders&type=edit&id=<?php echo $item->orderID; ?>"
                                       role="button" class="btn btn-success btn-xs"><i class="fa fa-fw fa-edit"></i></a>
                                    <a href="/admin/?act=orders&type=delete&id=<?php echo $item->orderID; ?>" class="btn btn-danger btn-xs delete-product" onclick="return confirm_click();"><i
