            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/admin?act=products&type=index"><i class="fa fa-circle-o"></i> List</a></li>
                        <li><a href="/admin?act=products&type=add"><i class="fa fa-circle-o"></i> Add</a></li>
                        <li><a href="/admin?act=cate_products&type=index"><i class="fa fa-circle-o"></i> Categories</a>
                        </li>
                    </ul>
                </li>
                <li class="treeview">
