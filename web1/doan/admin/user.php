    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Nam Sơn Auto</a> 
            </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li  >
                        <a class="active-menu"  href="user.php"><i class="fa fa-user fa-3x"></i> Users</a>
                    </li>				
                     <li  >
        ...
        ?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?php echo $list[$i]->getPassword(); ?></td>
                                            <td><?php echo $list[$i]->getName(); ?></td>
                                            <td><?php echo $list[$i]->getEmail(); ?></td>
                                            <td><?php echo date('d/m/Y', $list[$i]->getDob()); ?></td>
                                            <td><?php $p = $list[$i]->getPermision();
														if($p != 1)
														echo "khách hàng";
														else
														echo "admin"
